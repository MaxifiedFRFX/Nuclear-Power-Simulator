import { Card, CardContent, CardHeader, Button, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from "@mui/material"
        ...
        <div className="reacterCard">
            <Card className="reactorCard" sx={{
                ...
                <Card className="ReactorInnerCard" sx={{
                    ...
                    <CardContent>
                        <Typography>ReactorName</Typography>
